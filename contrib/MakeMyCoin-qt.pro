...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/MakeMyCoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/MakeMyCoin-cli.cpp \
           src/MakeMyCoin-tx.cpp \
           src/MakeMyCoin.cpp \
           src/db.cpp \
           ...
           src/qt/MakeMyCoin.cpp \
           src/qt/MakeMyCoinstrings.cpp \
...
RESOURCES += src/qt/MakeMyCoin.qrc src/qt/MakeMyCoin_locale.qrc

TRANSLATIONS += src/qt/locale/MakeMyCoin_bg.ts \
                src/qt/locale/MakeMyCoin_de.ts \
                src/qt/locale/MakeMyCoin_en.ts \
                src/qt/locale/MakeMyCoin_es.ts \
                src/qt/locale/MakeMyCoin_fi.ts \
                src/qt/locale/MakeMyCoin_fr.ts \
                src/qt/locale/MakeMyCoin_it.ts \
                src/qt/locale/MakeMyCoin_ja.ts \
                src/qt/locale/MakeMyCoin_pl.ts \
                src/qt/locale/MakeMyCoin_pt.ts \
                src/qt/locale/MakeMyCoin_ru.ts \
                src/qt/locale/MakeMyCoin_sk.ts \
                src/qt/locale/MakeMyCoin_sv.ts \
                src/qt/locale/MakeMyCoin_vi.ts \
                src/qt/locale/MakeMyCoin_zh_CN.ts \
                src/qt/locale/MakeMyCoin_zh_TW.ts
