...
pkgdatadir = $(datadir)/MakeMyCoin
pkgincludedir = $(includedir)/MakeMyCoin
pkglibdir = $(libdir)/MakeMyCoin
pkglibexecdir = $(libexecdir)/MakeMyCoin
...
CONFIG_HEADER = $(top_builddir)/src/config/MakeMyCoin-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/MakeMyCoin-config.h.in \
...
ACLOCAL = ${SHELL} /Users/vishalsachdeva/Downloads/MMCO/build-aux/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /Users/vishalsachdeva/Downloads/MMCO/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /Users/vishalsachdeva/Downloads/MMCO/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /Users/vishalsachdeva/Downloads/MMCO/build-aux/missing automake-1.16
AWK = awk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = MakeMyCoin-cli
BITCOIN_DAEMON_NAME = MakeMyCoind
BITCOIN_GUI_NAME = MakeMyCoin-qt
BITCOIN_TX_NAME = MakeMyCoin-tx
...
CPPFLAGS = -I/usr/local/opt/openssl/include -DBOOST_SPIRIT_THREADSAFE -DHAVE_BUILD_INFO -D__STDC_FORMAT_MACROS -I/usr/local/opt/berkeley-db@4/include -DMAC_OSX  -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -DHAVE_QT5
...
MAINT = 
MAKEINFO = ${SHELL} /Users/vishalsachdeva/Downloads/MMCO/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
OTOOL64 = :
PACKAGE = MakeMyCoin
PACKAGE_BUGREPORT = www.MakeMyCoin.org
PACKAGE_NAME = MakeMyCoin Core
PACKAGE_STRING = MakeMyCoin Core 1.0.0
PACKAGE_TARNAME = MakeMyCoin
PACKAGE_URL = 
...
X11XCB_LIBS = 
XGETTEXT = 
ZMQ_CFLAGS = -DZMQ_BUILD_DRAFT_API=1 -I/usr/local/include
ZMQ_LIBS = -L/usr/local/lib -lzmq
abs_builddir = /Users/vishalsachdeva/Downloads/MMCO
abs_srcdir = /Users/vishalsachdeva/Downloads/MMCO
abs_top_builddir = /Users/vishalsachdeva/Downloads/MMCO
abs_top_srcdir = /Users/vishalsachdeva/Downloads/MMCO
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /Users/vishalsachdeva/Downloads/MMCO/build-aux/install-sh
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_MakeMyCoin_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_MakeMyCoin_coverage.info test_MakeMyCoin.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/MakeMyCoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/MakeMyCoin-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/MakeMyCoin-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/MakeMyCoin-config.h
$(top_srcdir)/src/config/MakeMyCoin-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/MakeMyCoin-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/MakeMyCoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
#$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/MakeMyCoin-Qt
...
#$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/MakeMyCoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_MakeMyCoin.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_MakeMyCoin -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_MakeMyCoin_filtered.info: test_MakeMyCoin.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_MakeMyCoin_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_MakeMyCoin_coverage.info: baseline_filtered_combined.info test_MakeMyCoin_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_MakeMyCoin_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_MakeMyCoin_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_MakeMyCoin_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_MakeMyCoin.coverage/.dirstamp:  test_MakeMyCoin_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_MakeMyCoin.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_MakeMyCoin.coverage/ total.coverage/ $(OSX_APP)
