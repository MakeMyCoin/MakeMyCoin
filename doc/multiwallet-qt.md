...
In order to support loading of multiple wallets in MakeMyCoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is MakeMyCoin.cpp.
...
Changes to MakeMyCoin.cpp
----------------------
MakeMyCoin.cpp is the entry point into MakeMyCoin-qt, and as such, will require some minor modifications to provide hooks for
