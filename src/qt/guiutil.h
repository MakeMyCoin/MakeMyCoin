...
/** Utility functions used by the MakeMyCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render MakeMyCoin addresses in monospace font
...
// Parse "MakeMyCoin:" URI into recipient object, return true on successful parsing
