                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MakeMyCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MakeMyCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and MakeMyCoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zmmco"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MakeMyCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about MakeMyCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MakeMyCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MakeMyCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MakeMyCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a MakeMyCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MakeMyCoin Core help message to get a list with possible MakeMyCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MakeMyCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MakeMyCoin network", "", count));
}
...
{
    QString strTitle = tr("MakeMyCoin Core"); // default title
...
/** Creates context menu, its actions, and MakeMyCoins up all the relevant signals for mouse events. */
