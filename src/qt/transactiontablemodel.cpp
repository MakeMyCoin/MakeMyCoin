...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted MakeMyCoin to zmmco");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zmmco");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received MakeMyCoin from zmmco");
    case TransactionRecord::ZerocoinSpend_Change_zsnd:
        return tr("Minted Change as zmmco from zmmco Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zmmco to MakeMyCoin");
