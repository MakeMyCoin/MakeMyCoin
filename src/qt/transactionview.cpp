                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received MakeMyCoin from zmmco"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zmmco"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zsnd));
