...
QString BitcoinUnits::id(int unit)
{
    ...
    case MakeMyCoin:
        return QString("MMCO");
    case msnd:
        return QString("mMMCO");
    case usnd:
        return QString::fromUtf8("uMMCO");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        switch (unit) {
        case MakeMyCoin:
            return QString("tMMCO");
        case msnd:
            return QString("mtMMCO");
        case usnd:
            return QString::fromUtf8("μtMMCO");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        switch (unit) {
        case MakeMyCoin:
            return QString("MakeMyCoin");
        case msnd:
            return QString("Milli-MakeMyCoin (1 / 1" THIN_SP_UTF8 "000)");
        case usnd:
            return QString("Micro-MakeMyCoin (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
