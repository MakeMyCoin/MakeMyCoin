...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("MakeMyCoin Core"),
     ...
     * override -datadir in the MakeMyCoin.conf file in the default data directory
     * (to be consistent with MakeMyCoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
