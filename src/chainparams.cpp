...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000a8e747ced0ff418163ca18e2bfda03c9fa2a599fd351ff5c936c88ab77f"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1562224031, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("0476f64d02f672d19d8fa7462a773ccaf4d5e7cc82a8bd4c1e1a14a1a9b92270bbdf59b28a705a473424cca3bc8dd6a2dafb09d35adc4e3d348445c40a1dd88f35");
        nDefaultPort = 12163;
        bnProofOfWorkLimit = ~uint256(0) >> 20; //20 MakeMyCoin starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 30; // MakeMyCoin: 0.5 minutes
        nTargetSpacingSlowLaunch = 10 * 60;  // MakeMyCoin: 10 minutes (Slow launch - Block 288)
        nTargetSpacing = 1 * 60;  // MakeMyCoin: 60 Seconds
        nMaturity = 19;
        nMasternodeCountDrift = 20;
        nMaxMoneyOut = 34000000 * COIN;
         ...
         */
        const char* pszTimestamp = "MakeMyCoin Era is Here";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04cc08ac532ad5b7d0fe96db9c09b6d113cf2adc72ce56bacabcef72b59c51824dbc0e4729cd567de2a5da46c5871afc2cc833cdbffee1aa5fa18b2643ab42d85d") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1562224031;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 5562880;

        hashGenesisBlock = uint256("0x00000a8e747ced0ff418163ca18e2bfda03c9fa2a599fd351ff5c936c88ab77f");
        ...
        assert(hashGenesisBlock == uint256("0x00000a8e747ced0ff418163ca18e2bfda03c9fa2a599fd351ff5c936c88ab77f"));
        assert(genesis.hashMerkleRoot == uint256("0xc4cbe5560eac0c69d28a4474db943e9a0eacdb3b42b09b0d955921e0685d4753"));
    ...
    strSporkKey = "04BDE0EA74779B5D4A2BC9FD44362AD2641D9AC80AD52ED1E9B0301AFF58C57408C4A831BE5C3897F9597844BBE9672305D4105349FFBA243714609075B4D44638";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // MakeMyCoin: 1 day
        nTargetSpacing = 1 * 60;  // MakeMyCoin: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
       ...
       hashGenesisBlock = genesis.GetHash();
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet MakeMyCoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet MakeMyCoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet MakeMyCoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet MakeMyCoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet MakeMyCoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // MakeMyCoin: 1 day
        nTargetSpacing = 1 * 60;        // MakeMyCoin: 1 minutes
