/* src/config/MakeMyCoin-config.h.  Generated from MakeMyCoin-config.h.in by configure.  */
/* src/config/MakeMyCoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef MakeMyCoin_CONFIG_H

#define MakeMyCoin_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.MakeMyCoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "MakeMyCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "MakeMyCoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "MakeMyCoin"
