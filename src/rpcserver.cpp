...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop MakeMyCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "MakeMyCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MakeMyCoin features */
        {"MakeMyCoin", "masternode", &masternode, true, true, false},
        {"MakeMyCoin", "listmasternodes", &listmasternodes, true, true, false},
        {"MakeMyCoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"MakeMyCoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"MakeMyCoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"MakeMyCoin", "masternodedebug", &masternodedebug, true, true, false},
        {"MakeMyCoin", "startmasternode", &startmasternode, true, true, false},
        {"MakeMyCoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"MakeMyCoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"MakeMyCoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"MakeMyCoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"MakeMyCoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"MakeMyCoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"MakeMyCoin", "mnbudget", &mnbudget, true, true, false},
        {"MakeMyCoin", "preparebudget", &preparebudget, true, true, false},
        {"MakeMyCoin", "submitbudget", &submitbudget, true, true, false},
        {"MakeMyCoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"MakeMyCoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"MakeMyCoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"MakeMyCoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"MakeMyCoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"MakeMyCoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"MakeMyCoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"MakeMyCoin", "checkbudgets", &checkbudgets, true, true, false},
        {"MakeMyCoin", "mnsync", &mnsync, true, true, false},
        {"MakeMyCoin", "spork", &spork, true, true, false},
        {"MakeMyCoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"MakeMyCoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use MakeMyCoind, or the -server option to MakeMyCoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> MakeMyCoin-cli " + methodname + " " + args + "\n";
}
