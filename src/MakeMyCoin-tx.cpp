...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MakeMyCoin Core MakeMyCoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  MakeMyCoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded MakeMyCoin transaction") + "\n" +
                               "  MakeMyCoin-tx [options] -create [commands]   " + _("Create hex-encoded MakeMyCoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded MakeMyCoin transaction
