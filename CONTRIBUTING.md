Contributing to MakeMyCoin Core
============================

The MakeMyCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MakeMyCoin Core project, and is not to be
confused with overall MakeMyCoin Network Protocol consensus changes.

Whether a pull request is merged into MakeMyCoin Core rests with the project merge
...
Patches that change MakeMyCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the MakeMyCoin consensus, it must have been
...
The project leader is the release manager for each MakeMyCoin Core release.
